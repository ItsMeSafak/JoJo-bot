...
module.exports = {
    ...
    //Command values
    // TODO: Create a somesort of database?
    kiraList: ["My name is Yoshikage Kira. I'm 33 years old. My house is in the northeast section of Morioh, where all the villas are, and I am not married. " +
    ...
    dioList: ["Oh? You're Approaching Me?", "WRYYYYYYYYYYY!!!", "MUDA MUDA MUDA MUDAAAAAAA!!", "ZA WARUDO!", "But it was me, Dio!", "8 seconds have passed."],
    jotaroList: ["Yare yare daze...", "ORA ORA ORA ORA ORRRAAAA!!", "Star Platinum! Za Warudo!", "I can't beat the shit out of you without getting closer."]
}
